...
### 2.5 收藏目录文件更新提醒
*   **检查时间**：Service Worker 每天按浏览器本地时间 10:00 同步已收藏的 1 级目录子树，并检查设置中勾选的文件类型；默认勾选 PowerPoint 文件。
...
5.  **文件更新提醒**：在已收藏的 1 级目录下上传或修改已勾选类型的文件，验证每日 10:00 同步后 Popup 显示文件更新、站点和一级目录，扩展图标显示未读数量，点击文件名可以直达文件。
